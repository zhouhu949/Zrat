...
public class IPSeeker {
	...
	private static final String IP_FILE = System.getProperty("user.dir") + File.separator + "qqwry.dat";
	// 一些固定常量，比如记录长度等等
	...
	private IPSeeker()  {
		...
		try {
			ipFile = new RandomAccessFile(IP_FILE, "r");
                        ...
                        System.out.println(System.getProperty("user.dir") + File.separator + "qqwry.dat");
